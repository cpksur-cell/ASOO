...
export default async function AdminReviewsPage({
  ...
  const labels: ReviewLabels = {
    ...
    downloadPreparing: t('reports.downloadPreparing'),
    downloadFailed: t('reports.downloadFailed'),
    noFileStored: t('reports.noFileStored'),
    approvalDetails: t('reports.approvalDetails'),
    dlsReference: t('reports.dlsReference'),
    basin: t('reports.basin'),
    plot: t('reports.plot'),
    surveyMethod: t('reports.surveyMethod'),
    approvalNotes: t('reports.approvalNotes'),
    approvalNotesHint: t('reports.approvalNotesHint'),
